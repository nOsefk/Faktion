...
#print(best_params)  
#scores_rfr = cross_val_score(rfr, X_sm, y_sm, cv=10, verbose=5)
#y_pred = rfr.predict(X_test)
#print('Random Forest : ', scores_rfr.mean())
#print('Test Score : ', rfr.score(X_test,y_test))
#
#
#importances_rfr = pd.Series(rfr.feature_importances_, index = X_train.columns)
...
RForest = RandomForestClassifier(max_depth=10, min_samples_leaf=1, n_estimators=5500, random_state=42)
rfc = RForest.fit(X_sm,y_sm)
...
#GBoost = GradientBoostingClassifier(max_depth=4, learning_rate=0.005,min_samples_leaf=1, n_estimators=4000)
#gbc = GBoost.fit(X_sm,y_sm)
#y_pred = gbc.predict(X_test)
